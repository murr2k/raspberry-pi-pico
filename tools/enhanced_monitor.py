...
class PicoMonitor:
    ...
    def print_help(self):
        ...
        print("=" * 50)
        print("🎮 Monitor Commands (case insensitive):")
        ...
        print("   - Type QUIT, quit, Quit, or q to exit")
        print("   - Type HELP, help, or ? for this menu")
        print("   - Ctrl+C also exits gracefully")
        print("   - Commands are sent to Pico as typed")
    ...
    def run_interactive(self):
        ...
        print("💡 Type 'help' for commands, 'quit' to exit (case insensitive)")
